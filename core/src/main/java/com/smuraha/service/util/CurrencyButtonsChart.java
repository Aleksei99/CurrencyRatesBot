...
import static com.smuraha.service.enums.CallBackKeys.CCC;

@Service
@RequiredArgsConstructor
public class CurrencyButtonsChart implements CurrencyButtons {
    ...
    public List<List<InlineKeyboardButton>> getCurrencyButtons(Update update) throws JsonProcessingException {
        ...
        return telegramUI.getCurrencyButtons(List.of(currencies), CCC);
    }
}
